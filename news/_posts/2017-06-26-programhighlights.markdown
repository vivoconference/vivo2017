...
[Cristina Pattuelli](https://cristinapattuelli.com/) is an associate professor at the [School of Information at Pratt Institute](https://www.pratt.edu/academics/information/) in New York, US and a visiting professor at the Department of the Cultural Heritage at the University of Bologna, Italy. Her current research explores the intersection between cultural heritage and information representation and access. She is the founder and director of [Linked Jazz](https://linkedjazz.org/), a project that investigates the application of Linked Open Data technology to archival resources, and recently served as co-chair of the [LODLAM Summit 2017](http://summit2017.lodlam.net/).
...
###### [Synthesizing Web Application Logic Using Structural Analysis of Ontologies](http://vivoconference.org/schedule/#session-805)
...
###### [Making Sense of the Confusing World of Research Information Management](http://vivoconference.org/schedule/#session-806)
...
###### [The Unified Astronomy Thesaurus: Building, Managing, and Using a Community Supported Project](http://vivoconference.org/schedule/#session-807)
...
###### [Identity Management - PCC Task Group on Identity Management](http://vivoconference.org/schedule/#session-701)
...
###### [How to Make Your Research Networking System (RNS) Invaluable to Your Institution](http://vivoconference.org/schedule/#session-702)
...
###### [Managing Assets as Linked Data with Fedora](http://vivoconference.org/schedule/#session-703)
...
###### [Promoting FAIR data principles with figshare](http://vivoconference.org/schedule/#session-704)
...
###### [Crosswalking Research Area Vocabularies in VIVO](http://vivoconference.org/schedule/#session-705)
...
Explore our [online program](/schedule) for details on all of our scheduled content including abstracts and speaker info. Some highlights:

* [Lost in Translation - Challenges of Tailoring VIVO to the Needs of the German Scholarly Landscape](http://vivoconference.org/schedule/#session-103)
* [WheatVIVO: Integrating diverse data sources for an international perspective on wheat funding and research activities](http://vivoconference.org/schedule/#session-106)
* [Enriching VIVO profiles with a variety of research outputs](http://vivoconference.org/schedule/#session-108)
* [EarthCollab: Using VIVO to represent and explore linkages between research, instruments, and platforms](http://vivoconference.org/schedule/#session-111)
* [UCSF Profiles: Going from a system they like to a system they need](http://vivoconference.org/schedule/#session-118)
* [Scholars@Cornell: Visualizing the scholarship data](http://vivoconference.org/schedule/#session-119)
* [1,001 Ways to Repurpose VIVO Data](http://vivoconference.org/schedule/#session-128)
